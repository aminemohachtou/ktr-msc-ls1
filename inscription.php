<html>
    ...
    <body>
        ...
        <form method="POST" action="connexion.php">
            ...
            nom : </lablel><input type="text" name="nom"  size="40" maxlength="255"/><br>
            prenom : <input type="text" name="prenom"  size="40" maxlength="255"/><br>
            mail : <input type="text" name="mail"  size="40" maxlength="255"/><br>
           mot de passe :<input type="text" name="mail"  size="40" maxlength="255"/><br>
           <input type="button" name="login" value="login "  maxlength="255"/><br>
